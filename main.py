...
app = Flask(__name__)
@app.route('/')
def home(): return "CRAZY HIT & RUN - صاحي 24/7 ✅"
...
async def on_ready():
    ...
    if not crazy_entry.is_running(): crazy_entry.start()
