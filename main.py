...
HTML="""<!DOCTYPE html><html dir="rtl"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>V73 HYBRID LUXURY</title><link href="https://fonts.googleapis.com/css2?family=Cairo:wght@700;900&family=JetBrains+Mono:wght@800&display=swap" rel="stylesheet"><style>
...
<div class="header">👑 V73 HYBRID LUXURY — محرك V67</div>
<div class="sub">محرك V67 ANTI-LOSS + لوحة LUXURY الفخمة | TP 0.35$ | SL -0.65$ | ANTI-LOSS -5$</div>
<div class="ctrl-grid">
